(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var goToTop = function goToTop() {
      ...
      var c = (_b = (_a = document === null || document === void 0 ? void 0 : document.documentElement) === null || _a === void 0 ? void 0 : _a.scrollTop) !== null && _b !== void 0 ? _b : (_c = document === null || document === void 0 ? void 0 : document.body) === null || _c === void 0 ? void 0 : _c.scrollTop;
    ...
    var log = {
      info: function info() {
        ...
        return console.log.apply(console, __spreadArray(["%c%s", 'color: #9E9E9E'], args, false));
      },
      error: function error() {
        ...
        return console.log.apply(console, __spreadArray(["%c%s", 'color: #d81e06'], args, false));
      },
      warn: function warn() {
        var args = [];
        ...
        return console.log.apply(console, __spreadArray(["%c%s", 'color: #ffc107'], args, false));
      },
      debug: function debug() {
        ...
        return console.log.apply(console, __spreadArray(["%c%s", 'color: #2196f3'], args, false));
      },
      success: function success() {
        ...
        return console.log.apply(console, __spreadArray(["%c%s", 'color: #4caf50'], args, false));
      },
      color: function color(_color) {
        return function () {
          ...
          return console.log.apply(console, __spreadArray(["%c%s", "color: ".concat(_color)], args, false));
        };
      }
    };
    ...
    var coorDistance = function coorDistance(p1, p2) {
      var x1 = p1.x,
          y1 = p1.y;
      var x2 = p2.x,
          y2 = p2.y;
    ...
    exports.coorDistance = coorDistance;
